...
{
    public:
        VirtualBC() : BoundaryCondition(NON, VIRTUAL) {};
        VirtualBC(Position pos_) : BoundaryCondition(pos_, VIRTUAL) {};
        VirtualBC(double rank_, double neighbourRank_, Position pos_) : BoundaryCondition(pos_, VIRTUAL), rank(rank_), neighbourRank(neighbourRank_) {};
